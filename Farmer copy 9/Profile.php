        ...
        <div class="col-sm-6">
            <form action="" method="POST" class="mx-5">
                ...
                <div class="form-group">
                    ...
                    <input type="password"name="password" id="name" class="form-control" value="<?php echo $password ?>" style="height:65%; border-radius:.375rem; 
                                                 background-color:white; width:100%;border: var(--bs-border-width) solid var(--bs-border-color);">
                </div>
                <button type="submit" class="btn btn-success"name="Update"style="margin-top:2%">Update</button>
            </form>
        </div>
    </div>
</div>
